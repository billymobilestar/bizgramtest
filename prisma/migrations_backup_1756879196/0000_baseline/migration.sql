...
-- CreateEnum
CREATE TYPE "public"."SavedKind" AS ENUM ('POSTS', 'PEOPLE');
...
CREATE TABLE "public"."SavedList" (
    ...
    "name" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "kind" "public"."SavedKind" NOT NULL DEFAULT 'POSTS',
...
-- CreateIndex
CREATE UNIQUE INDEX "uniq_list_post" ON "public"."SavedItem"("listId", "postId");

-- CreateIndex
CREATE UNIQUE INDEX "uniq_list_profile" ON "public"."SavedItem"("listId", "profileId");
