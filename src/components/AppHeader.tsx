      ...
      <header className="fixed top-0 left-0 right-0 z-[60] border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-3 sm:px-4">
          ...
          <nav className="hidden sm:flex items-center gap-3">
            ...
            <Link className={linkCls('/messages')} href="/messages">Messages</Link>
            <Link className={linkCls('/projects')} href="/projects">Projects</Link>
            <Link className={linkCls('/saved')} href="/saved">Saved</Link>
          ...
          >
            ...
            <nav className="px-2 py-2">
              <ul className="flex flex-col">
                ...
                <li className="mt-2">
                  <Link href="/messages" onClick={() => setOpen(false)} className={linkCls('/messages')}>Messages</Link>
                </li>
                <li className="mt-2">
                  <Link href="/projects" onClick={() => setOpen(false)} className={linkCls('/projects')}>Projects</Link>
                </li>
                <li className="mt-2">
                  <Link href="/saved" onClick={() => setOpen(false)} className={linkCls('/saved')}>Saved</Link>
                </li>
